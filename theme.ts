...
const theme = extendTheme({
  colors: {
    ...
    gray: {
      900: tinycolor(baseGray).lighten(4).toString(),
      800: tinycolor(baseGray).lighten(8).toString(),
      700: tinycolor(baseGray).lighten(12).toString(),
      600: tinycolor(baseGray).lighten(16).toString(),
      500: tinycolor(baseGray).lighten(24).toString(),
      400: tinycolor(baseGray).lighten(32).toString(),
      300: tinycolor(baseGray).lighten(48).toString(),
      200: tinycolor(baseGray).lighten(72).toString(),
      100: tinycolor(baseGray).lighten(84).toString(),
    },
  },
});
